Examples provided with the SCICHEM 3.1 package
...
4) fourCorners: This is a multi-day power plant plume case study with the full  
photochemical mechanism (CB6r2) and aerosol and aqueous-phase chemistry for ozone  
and secondary PM2.5 impacts. This example uses 3-D meteorology fields based on WRF  
outputs and hypothetical SO2 and NOx emissions. The power plant is located in the  
Four Corners region in the southwestern US. This example uses namelist type input files.
