...
!DEC$ ATTRIBUTES DLLEXPORT, ALIAS : 'SCIPGETPROJECTTERRAINHEADEROMP' :: SCIPGetProjectTerrainHeader
!DEC$ ELSE
...
!DEC$ IF DEFINED (DUALBUILD)
!DEC$ ATTRIBUTES DLLEXPORT, ALIAS : 'SCIPGETPROJECTTERRAINHEADERINOMP' :: SCIPGetProjectTerrainHeaderIn
!DEC$ ELSE
...
!DEC$ IF DEFINED (DUALBUILD)
!DEC$ ATTRIBUTES DLLEXPORT, ALIAS : 'SCIPGETPROJECTTERRAINOMP' :: SCIPGetProjectTerrain
!DEC$ ELSE
...
!DEC$ IF DEFINED (DUALBUILD)
!DEC$ ATTRIBUTES DLLEXPORT, ALIAS : 'SCIPGETTERRAINSLICEOMP' :: SCIPGetTerrainSlice
!DEC$ ELSE
