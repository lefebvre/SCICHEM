...
!DEC$ ATTRIBUTES DLLEXPORT, ALIAS : 'SCIPDRAWFIELDOMP' :: SCIPDrawField
!DEC$ ELSE
...
!DEC$ IF DEFINED (DUALBUILD)
!DEC$ ATTRIBUTES DLLEXPORT, ALIAS : 'SCIPDRAWGRIDOMP' :: SCIPDrawGrid
!DEC$ ELSE
...
!DEC$ IF DEFINED (DUALBUILD)
!DEC$ ATTRIBUTES DLLEXPORT, ALIAS : 'SCIPGETFIELDMINMAXOMP' :: SCIPGetFieldMinMax
!DEC$ ELSE
