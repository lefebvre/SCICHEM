...
!DEC$ IF DEFINED (DUALBUILD)
!DEC$ ATTRIBUTES DLLEXPORT, ALIAS : 'SCIPLOADRELEASEMCFOMP' :: SCIPLoadReleaseMCF
!DEC$ ELSE
...
!DEC$ IF DEFINED (DUALBUILD)
!DEC$ ATTRIBUTES DLLEXPORT, ALIAS : 'SCIPSIZEPROJECTMCOMP' :: SCIPSizeProjectMC
!DEC$ ELSE
...
!DEC$ IF DEFINED (DUALBUILD)
!DEC$ ATTRIBUTES DLLEXPORT, ALIAS : 'SCIPLOADPROJECTMCOMP' :: SCIPLoadProjectMC
!DEC$ ELSE
