...
!DEC$ ATTRIBUTES DLLEXPORT, ALIAS : 'SCIPNUMPLOTCLASSESOMP' :: SCIPNumPlotClasses
!DEC$ ELSE
...
!DEC$ IF DEFINED (DUALBUILD)
!DEC$ ATTRIBUTES DLLEXPORT, ALIAS : 'SCIPGETPLOTCLASSESOMP' :: SCIPGetPlotClasses
!DEC$ ELSE
...
!DEC$ IF DEFINED (DUALBUILD)
!DEC$ ATTRIBUTES DLLEXPORT, ALIAS : 'SCIPNUMPLOTTIMESOMP' :: SCIPNumPlotTimes
!DEC$ ELSE
...
!DEC$ IF DEFINED (DUALBUILD)
!DEC$ ATTRIBUTES DLLEXPORT, ALIAS : 'SCIPGETPLOTTIMESOMP' :: SCIPGetPlotTimes
!DEC$ ELSE
