      subroutine stodi (neq, y, yh, nyh, yh1, ewt, savf, savr,
...
c-----------------------------------------------------------------------
 460  jcur = 0
      ...
      if (m .gt. 0) dsm = abs(h) * vnorm (n, acor, ewt)/tesco(2,nq)
...
c-----------------------------------------------------------------------
 ...
 530    savf(i) = acor(i) - yh(i,lmax)
      dup = abs(h) * vnorm (n, savf, ewt)/tesco(3,nq)
 ...
 620  if ((kflag .eq. 0) .and. (rh .lt. 1.1e0)) go to 610
      if (kflag .le. -2) rh = amin1(rh,0.1e0)
c-----------------------------------------------------------------------
